...
export const zh = {
  ...
  'node.summary': '摘要',
  'node.noMessage': '（无消息）',
  'branch.menu.title': '分叉分支',
  'branch.menu.expand': '展开分叉分支',
  'branch.menu.collapse': '收起分叉分支',
...
export const en = {
  ...
  'branch.menu.title': 'Fork branches',
  'branch.menu.expand': 'Expand fork branches',
  'branch.menu.collapse': 'Collapse fork branches',
