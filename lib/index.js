...
var SessionTree = class {
  ...
  constructor(sessionId, snapshot) {
    ...
    if (migrated.branchHeads !== void 0) {
      for (const [name3, head] of Object.entries(migrated.branchHeads)) {
...
function foldLegacyToolResultPairs(snapshot) {
  ...
  return {
    ...
    ...snapshot.branchHeads === void 0 ? {} : { branchHeads: Object.fromEntries(Object.entries(snapshot.branchHeads).map(([name3, head]) => [name3, reparent(head) ?? head])) },
    nodes
  };
}
